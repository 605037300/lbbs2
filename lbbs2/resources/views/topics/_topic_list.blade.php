      ...
      <li class="media">
        <div class="media-left">
          <a href="{{ route('users.show', [$topic->user_id]) }}">
            <img class="media-object img-thumbnail mr-3" style="width: 52px; height: 52px;" src="{{ $topic->user->avator }}" title="{{ $topic->user->name }}">
          </a>
        </div>
        ...
        <div class="media-body">
          ...
          <small class="media-body meta text-secondary">
            ...
            <a href="#" class='text-secondary' title='{{$topic->user_id}}'>
